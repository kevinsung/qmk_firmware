...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT_6x6(
        ...
        RALT(KC_RWIN) , KC_Z          , KC_X          , KC_C   , KC_V   , KC_B   ,                    KC_N   , KC_M  , KC_COMM, KC_DOT , KC_SLSH, KC_BSLS,
        KC_F10        , LCTL_T(KC_F11), RALT_T(KC_F12), KC_LEFT, KC_RGHT, _______,                    _______, KC_UP , KC_DOWN, KC_LBRC, KC_RBRC, RCTL_T(KC_F8),
                                                    KC_LWIN, LSFT_T(KC_F4), KC_F5,                    KC_DEL, KC_ENT, KC_RALT,
                                                                        TG(RAISE),                    TG(NUM),
                                                                           KC_SPC,                    KC_BSPC,
                                                                        MO(LOWER),                    KC_RSFT
    ),
    [LOWER] = LAYOUT_6x6(
        ...
        KC_BSPC      , LCTL(KC_Q) , LCTL(KC_W), LCTL(KC_E), LCTL(KC_R), LCTL(KC_T),        LCTL(KC_Y), KC_7   , KC_8   , KC_9   , KC_PSCR, KC_F12,
        KC_ENT       , LCTL(KC_A) , LCTL(KC_S), LCTL(KC_D), LCTL(KC_F), LCTL(KC_G),        LCTL(KC_H), KC_4   , KC_5   , KC_6   , _______, _______,
        LCTL(KC_SLSH), LCTL(KC_Z) , LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_B),        _______   , KC_1   , KC_2   , KC_3   , KC_DOT , KC_LALT,
        _______      , _______    , _______   , KC_PGUP   , KC_PGDN   , _______   ,        _______   , KC_HOME, KC_END , KC_VOLD, KC_VOLU, KC_MUTE,
                                     _______, LCTL(KC_LSFT), _______,                      _______, LWIN(KC_SPC), _______,
                                                             _______,                      _______,
                                                             _______,                      KC_0,
